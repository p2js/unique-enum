 ...
 */
export function uniqueEnumTransformer(context: ts.TransformationContext) {
    ...
    return (sourceFile: ts.SourceFile) => {
        ...
        function transformEnum(node: ts.EnumDeclaration): ts.VariableStatement {
                                                ...
                                                factory.createNewExpression(
                                                    ...
                                                    [
                                                        factory.createStringLiteral(
                                                            `Cannot instantiate ${enumName} variants after initialisation`
                                                        ),
                                                    ]
                                                )
                                            ),
                            ...
                            [
                                factory.createReturnStatement(
                                    factory.createTemplateExpression(
                                        factory.createTemplateHead(`${enumName}(`),
                                        [
